#
# Be sure to run `pod lib lint ContextMenuAuxiliaryPreview.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ContextMenuAuxiliaryPreview.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'ContextMenuAuxiliaryPreview/Classes/**/*'
  
  # s.resource_bundles = {
  #   'ContextMenuAuxiliaryPreview' => ['ContextMenuAuxiliaryPreview/Assets/*.png']
  # }
